...
impl ReconciliationItemFilter {
    ...
    pub fn has_filters(&self) -> bool {
        self.reconciliation_id.is_some() || self.source.is_some() || self.ledger_id.is_some() || self.journal_id.is_some() || self.book_reference.is_some() || self.book_description.is_some() || self.statement_reference.is_some() || self.statement_description.is_some() || self.status.is_some() || self.matched_with_id.is_some() || self.match_method.is_some() || self.has_difference.is_some() || self.difference_reason.is_some() || self.requires_adjustment.is_some() || self.adjustment_type.is_some() || self.adjustment_journal_id.is_some() || self.is_written_off.is_some() || self.write_off_reason.is_some() || self.write_off_approved_by.is_some() || self.is_outstanding.is_some() || self.outstanding_type.is_some() || self.notes.is_some()
    }
}
