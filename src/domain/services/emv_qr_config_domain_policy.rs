//! Domain policy for EmvQrConfig aggregate
//!
...
/// Domain policy for EmvQrConfig — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EmvQrConfig>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EmvQrConfigDomainPolicy = PermitAllPolicy<EmvQrConfig>;
