//! Domain policy for ReconciliationItem aggregate
//!
...
/// Domain policy for ReconciliationItem — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ReconciliationItem>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ReconciliationItemDomainPolicy = PermitAllPolicy<ReconciliationItem>;
