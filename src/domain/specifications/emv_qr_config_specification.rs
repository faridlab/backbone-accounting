//! Specifications for EmvQrConfig aggregate
//!
...
// Each predicate implements `Specification<EmvQrConfig>` and can be combined
...
//
// pub struct ActiveEmvQrConfigSpec;
// impl Specification<EmvQrConfig> for ActiveEmvQrConfigSpec {
//     fn is_satisfied_by(&self, e: &EmvQrConfig) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
