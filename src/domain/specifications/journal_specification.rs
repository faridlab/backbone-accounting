//! Specifications for Journal aggregate
//!
...
// Each predicate implements `Specification<Journal>` and can be combined
...
//
// pub struct ActiveJournalSpec;
// impl Specification<Journal> for ActiveJournalSpec {
//     fn is_satisfied_by(&self, e: &Journal) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
