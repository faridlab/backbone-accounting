//! Specifications for FullReconcile aggregate
//!
...
// Each predicate implements `Specification<FullReconcile>` and can be combined
...
//
// pub struct ActiveFullReconcileSpec;
// impl Specification<FullReconcile> for ActiveFullReconcileSpec {
//     fn is_satisfied_by(&self, e: &FullReconcile) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
