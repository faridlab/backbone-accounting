//! Specifications for Ledger aggregate
//!
...
// Each predicate implements `Specification<Ledger>` and can be combined
...
//
// pub struct ActiveLedgerSpec;
// impl Specification<Ledger> for ActiveLedgerSpec {
//     fn is_satisfied_by(&self, e: &Ledger) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
