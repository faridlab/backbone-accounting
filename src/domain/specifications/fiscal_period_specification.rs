//! Specifications for FiscalPeriod aggregate
//!
...
// Each predicate implements `Specification<FiscalPeriod>` and can be combined
...
//
// pub struct ActiveFiscalPeriodSpec;
// impl Specification<FiscalPeriod> for ActiveFiscalPeriodSpec {
//     fn is_satisfied_by(&self, e: &FiscalPeriod) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
