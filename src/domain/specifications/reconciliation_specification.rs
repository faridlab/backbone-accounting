//! Specifications for Reconciliation aggregate
//!
...
// Each predicate implements `Specification<Reconciliation>` and can be combined
...
//
// pub struct ActiveReconciliationSpec;
// impl Specification<Reconciliation> for ActiveReconciliationSpec {
//     fn is_satisfied_by(&self, e: &Reconciliation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
