//! Specifications for Account aggregate
//!
...
// Each predicate implements `Specification<Account>` and can be combined
...
//
// pub struct ActiveAccountSpec;
// impl Specification<Account> for ActiveAccountSpec {
//     fn is_satisfied_by(&self, e: &Account) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
