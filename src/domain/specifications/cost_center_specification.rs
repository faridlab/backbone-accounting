//! Specifications for CostCenter aggregate
//!
...
// Each predicate implements `Specification<CostCenter>` and can be combined
...
//
// pub struct ActiveCostCenterSpec;
// impl Specification<CostCenter> for ActiveCostCenterSpec {
//     fn is_satisfied_by(&self, e: &CostCenter) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
