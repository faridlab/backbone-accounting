//! Specifications for FinancialStatement aggregate
//!
...
// Each predicate implements `Specification<FinancialStatement>` and can be combined
...
//
// pub struct ActiveFinancialStatementSpec;
// impl Specification<FinancialStatement> for ActiveFinancialStatementSpec {
//     fn is_satisfied_by(&self, e: &FinancialStatement) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
