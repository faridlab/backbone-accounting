...
//!
//! Thin newtype over `backbone_orm::GenericCrudRepository<Ledger, backbone_orm::SoftDelete>`.
...
backbone_core::impl_crud_repository!(LedgerRepository, Ledger, soft_delete);
