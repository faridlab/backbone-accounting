...
pub fn account_validator() -> AccountValidator {
    EntityValidator::new()
        ...
        .rule(OptionalNotBlank::new("name_en", |e: &Account| {
            e.name_en.as_deref()
        }))
        ...
        .rule(OptionalNotBlank::new("bank_name", |e: &Account| {
            e.bank_name.as_deref()
        }))
        .rule(OptionalNotBlank::new(
            "bank_account_number",
            |e: &Account| e.bank_account_number.as_deref(),
        ))
        .rule(OptionalNotBlank::new("bank_account_name", |e: &Account| {
            e.bank_account_name.as_deref()
        }))
        .rule(OptionalNotBlank::new("bank_branch", |e: &Account| {
            e.bank_branch.as_deref()
        }))
