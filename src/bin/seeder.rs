...
use backbone_accounting::seeders::SeedEmvQrConfigSeeder;
use backbone_accounting::seeders::SeedBankCheckSequenceSeeder;
use backbone_accounting::seeders::SeedPrintedCheckSeeder;
use backbone_accounting::seeders::SeedTaxTagRepairRunSeeder;
...
async fn main() -> Result<()> {
    ...
    seeders.push(Box::new(SeedCostCenterSeeder::new()));
    seeders.push(Box::new(SeedEmvQrConfigSeeder::new()));
    seeders.push(Box::new(SeedBankCheckSequenceSeeder::new()));
    seeders.push(Box::new(SeedPrintedCheckSeeder::new()));
    seeders.push(Box::new(SeedTaxTagRepairRunSeeder::new()));
