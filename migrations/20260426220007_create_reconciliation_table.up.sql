...
CREATE TABLE IF NOT EXISTS accounting.reconciliations (
    ...
    opening_book_balance NUMERIC(18, 2) NOT NULL,
    opening_statement_balance NUMERIC(18, 2) NOT NULL,
    previous_reconciliation_id UUID,
    closing_book_balance NUMERIC(18, 2) NOT NULL,
    closing_statement_balance NUMERIC(18, 2) NOT NULL,
    total_matched_debits NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (total_matched_debits >= 0),
    total_matched_credits NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (total_matched_credits >= 0),
    matched_count INTEGER NOT NULL DEFAULT 0 CHECK (matched_count >= 0),
    total_unmatched_book_debits NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (total_unmatched_book_debits >= 0),
    total_unmatched_book_credits NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (total_unmatched_book_credits >= 0),
    unmatched_book_count INTEGER NOT NULL DEFAULT 0 CHECK (unmatched_book_count >= 0),
    total_unmatched_statement_debits NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (total_unmatched_statement_debits >= 0),
    total_unmatched_statement_credits NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (total_unmatched_statement_credits >= 0),
