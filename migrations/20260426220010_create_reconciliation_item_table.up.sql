...
CREATE TABLE IF NOT EXISTS accounting.reconciliation_items (
    ...
    book_debit NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (book_debit >= 0),
    book_credit NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (book_credit >= 0),
    statement_date DATE,
    statement_reference TEXT,
    statement_description TEXT,
    statement_debit NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (statement_debit >= 0),
    statement_credit NUMERIC(18, 2) NOT NULL DEFAULT 0 CHECK (statement_credit >= 0),
